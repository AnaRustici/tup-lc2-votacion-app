            ...
            if (response.ok) {
                ...
                for(i=0 ; i<25 ; i++){
                    if(distritoId == i){
                        ...
                        svgMapa.innerHTML = provinciasSVG[i].svg;
                        //modificamos el html svg con el arreglo de objetos posicion i
                    }
                }
